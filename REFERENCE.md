...
| [`finite_non_negative`](inc/damp/math/math.hpp#L445) | True if x is finite and non-negative ($`x \ge 0`$) |
...
| [`wrap_pi`](inc/damp/math/math.hpp#L541) | Wrap an angle to $`[-\pi,\pi)`$ |
| [`wrap_two_pi`](inc/damp/math/math.hpp#L559) | Wrap an angle to $`[0, 2\pi)`$ |
